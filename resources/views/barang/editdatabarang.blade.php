                            ...
                            <form action="/updatebarang/{{ $data->id }}" method="post" enctype="multipart/form-data">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <div class="input-group mb-3">
                                            <span class="input-group-text" id="basic-addon1">Rp.</span>
                                            <input type="number" name="hargajual" class="form-control" id="inputEmail3"
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-10">
                                        <input type="text" name="deskripsi" class="form-control" id="inputEmail3"
