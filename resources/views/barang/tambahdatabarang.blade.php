                ...
                <form action="/insertbarang" method="post" enctype="multipart/form-data">
                    ...
                    @enderror
                        ...
                        <div class="col-lg mg-t-10 mg-lg-t-0 mt-3 mb-3">
                            ...
                            <div class="">
                                <textarea class="form-control select2" required type="text" name="deskripsi[]" class=""
                    ...
                    <div class="text-center mt-3">
                        <button type="button" value="Tambah" id="tambah" class="btn btn-primary btn-sm mb-3"><i
                                class="fas fa-plus"></i></button>
                        <button type="button" value="Hapus" id="hapus" class="btn btn-outline-primary btn-sm mb-3"><i
