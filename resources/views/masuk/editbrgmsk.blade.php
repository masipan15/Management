                    ...
                    <div class="card-body">
                        ...
                        <form action="/updatebrgmsk/{{ $data->id }}" method="post" enctype="multipart/form-data">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name="suppliers_id" aria-label="Default select example"
                                        id="suppliers_id">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <select class="form-select" name="barangs_id" aria-label="Default select example"
                                        ...
                                        @foreach ($barang as $p)
                                            <option value="{{ $p->id }}" data-merk="{{ $p->merk }}"
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <input type="text" required name="kategoris_id" readonly class="form-control"
                                        id="inputEmail3" value="{{ $data->kategoris_id }}">
                                </div>
                            </div>
                            <div class="row mb-3">
                                ...
                                <div class="col-sm-10">
                                    <div class="input-group mb-3">
                                        ...
                                        <input type="text" readonly id="harga" name="harga" class="form-control"
