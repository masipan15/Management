                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div class="card-item">
                                        ...
                                        <div class="card-item-body">
                                            <div class="card-item-stat">
                                                <h4 class="font-weight-bold">{{ $jumlahpelanggan }}</h4>
                                                <small><b class="text-success"></b></small>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body p-6">
                                    <div class="row align-items-center">
                                        <div class="offset-xl-3 offset-sm-6 col-xl-8 col-sm-6 col-12 img-bg ">
                                            ...
                                            <p class="tx-white-7 mb-1">You have {{ $jumlahpermintaandesain }} projects to
                                                finish, you
                                                had completed <b class="text-warning">57%</b> from your montly
                                                level,
                                                Keep going to your level
                                ...
                                <div class="card-body p-6">
                                    <div class="row align-items-center">
                                        <div class="offset-xl-3 offset-sm-6 col-xl-8 col-sm-6 col-12 img-bg ">
                                            ...
                                            <p class="tx-white-7 mb-1">You have {{ $penjualan }} projects to
                                                finish, you
                                                had completed <b class="text-warning">57%</b> from your montly
                                                level,
                                                Keep going to your level
