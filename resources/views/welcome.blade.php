                                    ...
                                    <div class="card bg-primary custom-card card-box">
                                        <div class="card-body p-4">
                                            <div class="row align-items-center">
                                                ...
                                                <img src="{{ asset('acstemplate/assets/img/pngs/work3.png') }}"
                                                    alt="user-img" class="wd-200">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                            ...
                                            <td class="text-right">
                                                <div class="d-inline-block">
                                                    <h6 class="mb-2 tx-15 font-weight-semibold">$45.234<i
                                                            class="fas fa-level-up-alt ml-2 text-success m-l-10"></i>
                                                    </h6>
                            ...
                            <div class="card custom-card">
                                <div class="card-body">
                                    <div class="row row-sm">
                                        ...
                                        <div class="col-6">
                                            <img src="{{ asset('acstemplate/assets/img/pngs/work.png') }}"
                                                alt="image" class="best-emp">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col col-auto">
                                            <div class="mt-3">
                                                <div class="">
                                                    <img alt="" class="ht-50"
                                                        src="{{ asset('acstemplate/assets/img/media/project-logo.png') }}">
                                                </div>
                                            </div>
                                        </div>
                                    </div>
