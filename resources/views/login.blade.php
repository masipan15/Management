...
<!-- Mirrored from laravel.spruko.com/spruha/ltr/signin by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 22 Sep 2022 01:20:03 GMT -->
						...
						<div class="row row-sm">
							<div class="col-lg-6 col-xl-5 d-none d-lg-block text-center bg-primary details">
								<div class="mt-5 pt-4 p-2 pos-absolute">
									{{-- <img src="{{asset('acstemplate/assets/img/brand/logo-light.png')}}" class="header-brand-img mb-4" alt="logo"> --}}
								...
								<div class="container-fluid">
									<div class="row row-sm">
										<div class="card-body mt-2 mb-2">
											{{-- <img src="{{asset('acstemplate/assets/img/brand/logo.png')}}" class=" d-lg-none header-brand-img text-left float-left mb-4" alt="logo">
											<div class="clearfix"></div> --}}
                                            ...
                                            <form action="/loginproses" method="post">
												...
												<div class="form-group text-left">
													<label>Sandi</label>
													<input class="form-control" name="password" placeholder="Masukkan Sandi Anda" type="password">
												</div>
