							...
							<div class="col-xl-3 col-lg-12 col-md-12">
								<div class="card custom-card">
									...
									<div class="card-body text-center item-user">
										<div class="profile-pic">
											<div class="profile-pic-img">
												...
												<img src="{{ asset ('acstemplate/assets/img/users/1.jpg')}}" class="rounded-circle" alt="user">
											</div>
									...
									<ul class="item1-links nav nav-tabs  mb-0">
										...
										<li class="nav-item">
											<a data-target="#profile"  class="nav-link active" data-toggle="tab" role="tablist"><i class="ti-credit-card icon1"></i> My Profile</a>
										</li>
										<li class="nav-item">
							...
							<div class="col-xl-9 col-lg-12 col-md-12">
								<div class="card custom-card">
											<div class="tab-pane fade" id="profile" role="tabpanel">
												<div class="d-flex align-items-start pb-3 border-bottom"> <img src="{{ asset ('acstemplate/assets/img/users/1.jpg')}}" class="img rounded-circle avatar-xl" alt="">
