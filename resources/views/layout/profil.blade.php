                                    ...
                                    <ul class="item1-links nav nav-tabs  mb-0">
                                        ...
                                        <li class="nav-item">
                                            <a data-target="#" class="nav-link active" data-toggle="tab"
                                                role="tablist"><i class="ti-credit-card icon1"></i><b>Profil</b></a>
                                        </li>
                                        <li class="nav-item">
                                            <a href="/welcome" class="nav-link"><i class="ti-power-off icon1"></i><b>Kembali</b></a>
                                        </li>
                                    </ul>
                                </div>
                            </div>
                                                        ...
                                                        <div class="py-2">
                                                            <div class="row py-2">
                                                                ...
                                                                <div class="col-md-6 pt-md-0 pt-3"> <label
                                                                        id="email"><b>Email</b></label> <input type="email"
                                                                        name="email" readonly
                                                                        value="{{ Auth::user()->email }}"
                                                                        class="form-control"> </div>
                                                            </div>
                                                            <div class="row py-2">
                                                                <div class="col-md-6"> <label id="alamat"><b>Alamat</b></label>
                                                                    <input type="text" name="alamat" readonly
                                                                        value="{{ Auth::user()->alamat }}"
                                                                        class="form-control">
                                                                </div>
                                                                <div class="col-md-6 pt-md-0 pt-3"> <label id="notelpon"><b>No
                                                                    Telpon</b></label> <input type="number" name="notelpon"
