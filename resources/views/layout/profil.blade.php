                        ...
                        <div class="col-xl-3 col-lg-12 col-md-12">
                            <div class="card custom-card">
                                    ...
                                    <div class="profile-pic">
                                        <div class="profile-pic-img">
                                            <span class="bg-success dots" data-toggle="tooltip" data-placement="top"
                                                title="online"></span>
                                            <img class="rounded-circle" src="{{ Auth::user()->foto }}"
                                                alt="user">
                                        </div>
                                ...
                                <ul class="item1-links nav nav-tabs  mb-0">
                                    ...
                                    <li class="nav-item">
                                        <a data-target="/editprofil" class="nav-link" data-toggle="tab"
                                ...
                                <div class="card-body">
                                    <div class="tab-content" id="myTabContent">
                                        <div class="tab-pane fade show active" id="profile" role="tabpanel">
                                            ...
                                            <div class="py-2">
                                                <div class="row py-2">
                                                    <div class="col-md-6"> <label id="name">Nama</label> <input
                                                            type="text" class="form-control" name="name"
                                                            readonly value="{{ Auth::user()->name }}"> </div>
                                                ...
                                                <div class="row py-2">
                                                    <div class="col-md-6"> <label id="alamat">Alamat</label> <input
                                                            type="text" name="alamat" readonly
                                                            class="form-control"> </div>
