                                                ...
                                                <form action="/updateuserdesain/{{ $data->id }}" method="post"
                                                    ...
                                                    <div class="row mb-3">
                                                        ...
                                                        <div class="col-sm-10">
                                                            ...
                                                            id="namapemesan" value="{{ $data->namapemesan }}"
                                                                    id="inputEmail3">                                    
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                        <label for="inputEmail3"
                                                            class="col-sm-2 col-form-label">Permintaan</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" name="permintaan" class="form-control"
                                                            id="exampleInputEmail1" value="{{ $data->permintaan }}"
                                                                    id="inputEmail3">                                    
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
                                                    ...
                                                    <div class="row mb-3">
                                                        <label for="inputEmail3"
                                                            class="col-sm-2 col-form-label">Ukuran</label>
                                                        <div class="col-sm-10">
                                                            <input type="text" name="ukuran" class="form-control"
                                                                id="exampleInputEmail1" value="{{ $data->ukuran }}"
                                                                    id="inputEmail3">                                    
                                                        </div>
                                                    </div>
                                                    <div class="row mb-3">
