                            ...
                            <div class="card-body p-6">
                                <div class="row align-items-center">
                                    <div class="offset-xl-3 offset-sm-6 col-xl-8 col-sm-6 col-12 img-bg ">
                                        ...
                                        <p class="tx-white-7 mb-1">You have {{ $jumlahbarang }} projects to finish, you
                            ...
                            <div class="card-body">
                                <div class="card-item">
                                    ...
                                    <div class="card-item-title mb-2">
                                        <label class="main-content-label tx-13 font-weight-bold mb-1">Jumlah Barang</label>

                                    </div>
                                    <div class="card-item-body">
                                        <div class="card-item-stat">
                                            <h4 class="font-weight-bold">{{ $jumlahbarang }}</h4>
                        ...
                        <div class="card custom-card">
                            <div class="card-body">
                                <div class="card-item">
                                    ...
                                    <div class="card-item-title  mb-2">
                                        <label class="main-content-label tx-13 font-weight-bold mb-1">Jumlah Desain</label>

                                    </div>
                                    <div class="card-item-body">
                                        <div class="card-item-stat">
                                            <h4 class="font-weight-bold">{{ $jumlahpermintaandesain }}</h4>
                                    ...
                                    <div class="card-header border-bottom-0 pt-0 pl-0 pr-0 d-flex">
                                        ...
                                        <div class="ml-auto">
                                            ...
                                            <div class="dropdown-menu">
                                                ...
                                                <a class="dropdown-item" href="#"><i class="fa fa-cog mr-2"></i>
                                                    Settings</a>
                                            </div>
                                        </div>
                                    </div>
                                            ...
                                            <tbody>
                                                        ...
                                                        <div class="demo-avatar-group my-auto float-right">
                                                            <div class="main-img-user avatar-sm">
                                                                <img alt="avatar" class="rounded-circle"
                                                                    src="{{ asset('acstemplate/assets/img/users/1.jpg') }}">
                                                            </div>
                                                            <div class="main-img-user avatar-sm">
                                                                <img alt="avatar" class="rounded-circle"
                                                                    src="{{ asset('acstemplate/assets/img/users/2.jpg') }}">
                                                            </div>
                                                            <div class="main-img-user avatar-sm">
                                                                <img alt="avatar" class="rounded-circle"
                                                                    src="{{ asset('acstemplate/assets/img/users/3.jpg') }}">
                                                            </div>
                                                            <div class="main-img-user avatar-sm">
                                                                <img alt="avatar" class="rounded-circle"
                                                                    src="{{ asset('acstemplate/assets/img/users/4.jpg') }}">
                                                            </div>
                                                        </div>
                                                    </td>
                                                ...
                                                <tr>
                                                    <td class="font-weight-semibold d-flex"><label
                                                            ...
                                                            Generate ideas for design</span>
                                                    </td>
                                                    <td class="text-nowrap">
                                                        <div class="demo-avatar-group my-auto float-right">
                                                            <div class="main-img-user avatar-sm">
                                                                <img alt="avatar" class="rounded-circle"
                                                                    src="{{ asset('acstemplate/assets/img/users/5.jpg') }}">
                                                            </div>
                                                            <div class="main-img-user avatar-sm">
                                                                <img alt="avatar" class="rounded-circle"
                                                                    src="{{ asset('acstemplate/assets/img/users/6.jpg') }}">
                                                            </div>
                                                            <div class="main-img-user avatar-sm">
                                                                <img alt="avatar" class="rounded-circle"
                                                                    src="{{ asset('acstemplate/assets/img/users/7.jpg') }}">
                                                            </div>
                                                            <div class="main-img-user avatar-sm">
                                                                <img alt="avatar" class="rounded-circle"
                                                                    src="{{ asset('acstemplate/assets/img/users/8.jpg') }}">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">37<i class=""></i></td>
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-nowrap">
                                                        <div class="demo-avatar-group my-auto float-right">
                                                            <div class="main-img-user avatar-sm">
                                                                <img alt="avatar" class="rounded-circle"
                                                                    src="{{ asset('acstemplate/assets/img/users/11.jpg') }}">
                                                            </div>
                                                            <div class="main-img-user avatar-sm">
                                                                <img alt="avatar" class="rounded-circle"
                                                                    src="{{ asset('acstemplate/assets/img/users/12.jpg') }}">
                                                            </div>
                                                            <div class="main-img-user avatar-sm">
                                                                <img alt="avatar" class="rounded-circle"
                                                                    src="{{ asset('acstemplate/assets/img/users/9.jpg') }}">
                                                            </div>
                                                            <div class="main-img-user avatar-sm">
                                                                <img alt="avatar" class="rounded-circle"
                                                                    src="{{ asset('acstemplate/assets/img/users/10.jpg') }}">
                                                            </div>
                                                        </div>
                                                    </td>
                                                    <td class="text-center">37<i class=""></i></td>
