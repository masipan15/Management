...
`<div class="row mb-3">
    ...
    <div class="form-label">
        <select class="form-control select2" required style="width:100%;" name="nama_barang" class="" id="nama_barang">
            <option value="" selected disabled>Pilih Nama Barang</option>
            @foreach ($barang as $item)
                <option value="{{ $item->id }}" data-harga_jual="{{ $item->hargajual }}"
                    data-kodebarang_keluar="{{ $item->kodebarang }}" data-merk_keluar="{{ $item->merk }}"
    ...
    <div class="col-lg-12 col-md-12">
        <div class="row row-sm">
            <div class="col-lg">
                ...
                <input class="form-control text-center" readonly required name="kodebarang_keluar" type="text"
                    id="kodebarang_keluar">
            </div>
            ...
            <div class="col-lg mg-t-10 mg-lg-t-0">
                ...
                <input class="form-control text-center" readonly required name="harga_jual" id="harga_jual"
                    type="number">
            </div>
            <div class="col-lg mg-t-10 mg-lg-t-0">
                <p class="form-label">Jumlah</p>
                <input class="form-control text-center" required name="jumlah" id="jumlah" type="text">
            </div>
            <div class="col-lg mg-t-10 mg-lg-t-0">
                <p class="form-label">Total</p>
                <input class="form-control text-center" required name="total" id="total" type="text">
            </div>
...
`<tr>\
    ...
    <td>` + item.namabarangs.namabarang + `</td>
    <td>` + item.kodebarang_keluar + `</td>
    <td>` + item.merk_keluar + `</td>
