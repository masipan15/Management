                            ...
                            <div class="container-fluid">
                                <div class="row row-sm">
                                    <div class="card-body mt-2 mb-2">
                                        ...
                                        <p class="mb-4 text-muted tx-13 ml-0 text-left">Gratis untuk mendaftar dan
                                            hanya
                                            membutuhkan waktu satu menit.</p>
                                        <nav class="navbar navbar-light bg-light">
                                            <form class="container-fluid justify-content-start">
                                                <a href="registerdesain" class="btn btn-sm btn-outline-secondary "
                                                    type="button">User Desain</a>

                                                <a href="registerservis" class="btn btn-sm btn-outline-secondary"
